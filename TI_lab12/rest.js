...
function _insert(form)  {
    ...
    request.open("POST", "/~8kusm/TI_lab12/rest/save", true);
    request.send(txt);
}
...
print (id_mongo);
    request.open("DELETE", "/~8kusm/TI_lab12/rest/delete1/"+id_mongo, true);
...
function _update(form) {
    ...
    request.open("PUT", "/~8kusm/TI_lab12/rest/update1/"+id_mongo, true);
    request.send(txt);
}
